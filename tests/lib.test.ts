...
import { api, directorsOf, frenchCertification, watchProviders, pickTrailer, type MovieDetail } from "@/lib/tmdb";
...
describe("regroupement des offres de streaming en Belgique", () => {
